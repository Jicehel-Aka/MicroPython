...
QDEF1(MP_QSTR_A, 46564, 1, "A")
QDEF1(MP_QSTR_B, 46567, 1, "B")
QDEF1(MP_QSTR_BytesIO, 46874, 7, "BytesIO")
QDEF1(MP_QSTR_C, 46566, 1, "C")
QDEF1(MP_QSTR_D, 46561, 1, "D")
QDEF1(MP_QSTR_DOWN, 18231, 4, "DOWN")
QDEF1(MP_QSTR_L1, 29496, 2, "L1")
QDEF1(MP_QSTR_LEFT, 28062, 4, "LEFT")
QDEF1(MP_QSTR_MENU, 51254, 4, "MENU")
QDEF1(MP_QSTR_R1, 29926, 2, "R1")
QDEF1(MP_QSTR_RIGHT, 31173, 5, "RIGHT")
QDEF1(MP_QSTR_RUN, 1164, 3, "RUN")
...
QDEF1(MP_QSTR_file_read, 20814, 9, "file_read")
QDEF1(MP_QSTR_file_write, 12097, 10, "file_write")
QDEF1(MP_QSTR_fill_circle, 38887, 11, "fill_circle")
QDEF1(MP_QSTR_fill_rect, 60725, 9, "fill_rect")
QDEF1(MP_QSTR_fill_triangle, 48699, 13, "fill_triangle")
...
QDEF1(MP_QSTR_is_sound_playing, 3576, 16, "is_sound_playing")
QDEF1(MP_QSTR_is_vibrating, 63002, 12, "is_vibrating")
...
QDEF1(MP_QSTR_joystick, 23711, 8, "joystick")
QDEF1(MP_QSTR_language, 9431, 8, "language")
QDEF1(MP_QSTR_length, 34649, 6, "length")
QDEF1(MP_QSTR_line, 7371, 4, "line")
QDEF1(MP_QSTR_list_py, 45649, 7, "list_py")
...
QDEF1(MP_QSTR_play_pcm8, 38136, 9, "play_pcm8")
...
QDEF1(MP_QSTR_released, 36104, 8, "released")
QDEF1(MP_QSTR_reversed, 28321, 8, "reversed")
QDEF1(MP_QSTR_run_file, 15861, 8, "run_file")
QDEF1(MP_QSTR_screenshot, 59273, 10, "screenshot")
QDEF1(MP_QSTR_seek, 30109, 4, "seek")
QDEF1(MP_QSTR_set_color, 30501, 9, "set_color")
QDEF1(MP_QSTR_set_controls, 18412, 12, "set_controls")
QDEF1(MP_QSTR_set_credits, 52838, 11, "set_credits")
...
QDEF1(MP_QSTR_tr, 28547, 2, "tr")
QDEF1(MP_QSTR_triangle, 39403, 8, "triangle")
...
QDEF1(MP_QSTR_vibrate, 61754, 7, "vibrate")
